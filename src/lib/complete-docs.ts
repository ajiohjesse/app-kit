...
import { errorReportingDocs } from "@/lib/error-reporting-docs";
...
import { authGuardDocs } from "@/lib/auth-guard-docs";
...
export const completeDocs: Partial<Record<string, CompleteDocSlots>> = {
  ...
  "error-reporting": errorReportingDocs,
